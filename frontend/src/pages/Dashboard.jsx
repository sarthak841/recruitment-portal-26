...
function formatSlotDate(dateStr) {
  ...
  // Append IST offset so "YYYY-MM-DD" isn't shifted by the UTC parse
...
function getSlotDateTime(slotInfo) {
  ...
  // FIX: Append IST offset so the string is parsed as IST, not UTC.
  // Without this, "2026-06-29T10:00" is treated as 10:00 UTC = 15:30 IST,
  // making the QR appear locked for 5h30m longer than it should.
  const IST_OFFSET = "+05:30";
  const dt = new Date(`${slotInfo.slotDate}T${slotInfo.startTime}${IST_OFFSET}`);
